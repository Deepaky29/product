                ...
                >
                  ...
                  <div className="flex gap-2 mt-4">
                    <button
                      ...
                      className="flex-1 bg-indigo-600 text-white text-sm py-1.5 rounded"
                    >
                      Publish
                    </button>
                    ...
                    <button className="border px-3 rounded text-sm">🗑</button>
                  </div>
                </div>
              ))}
            </div>
